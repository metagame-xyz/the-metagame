...
import { ACHIEVEMENT_NAME, NETWORK, ETHERSCAN_API_KEY, PUBLIC_KEY, APP_NAME } from '../../utils/constants';
...
const etherscanAPIURLBuilder = (address: string) => `https://api${etherscanNetworkString}.etherscan.io/api?apikey=${ETHERSCAN_API_KEY}&module=account&action=txlist&address=${address}&startblock=0&endblock=999999999&sort=asc&page=1&offset=1`;
