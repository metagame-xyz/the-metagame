...
/* Frontend Constants */
export const BIRTHBLOCK_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BIRTHBLOCK_CONTRACT_ADDRESS;
export const TOKEN_GARDEN_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TOKEN_GARDEN_CONTRACT_ADDRESS;
export const HEARTBEAT_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_HEARTBEAT_CONTRACT_ADDRESS;
